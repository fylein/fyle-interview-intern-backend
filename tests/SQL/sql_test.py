...
def create_n_graded_assignments_for_teacher(number: int = 0, teacher_id: int = 3) -> int:
    """
...
def test_get_grade_A_assignments_for_teacher_with_max_grading():
    ...
    # Create and grade 5 assignments for the default teacher (teacher_id=3)
    grade_a_count_3 = create_n_graded_assignments_for_teacher(5)
    ...
    grade_a_count_4 = create_n_graded_assignments_for_teacher(10, 4)
