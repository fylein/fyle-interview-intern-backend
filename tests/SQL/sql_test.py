...
def test_get_assignments_in_various_states():
    ...
    """Modified the expected result after viewing its initial states using SQL Viewer"""
    ...
    """Modified the expected result by incrementing graded count and decrementing submitted count"""
