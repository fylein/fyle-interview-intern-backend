...
class Assignment(db.Model):
    ...
    def submit(cls, _id, teacher_id, auth_principal: AuthPrincipal):
        ...
        if assignment.state == AssignmentStateEnum.SUBMITTED or assignment.state==AssignmentStateEnum.GRADED:
            raise FyleError(400, message='only a draft assignment can be submitted')
    ...
    @classmethod
    def get_assignments_by_teacher(cls, id):
        return cls.query.filter(cls.teacher_id == id, cls.state != AssignmentStateEnum.DRAFT).all()
    @classmethod
