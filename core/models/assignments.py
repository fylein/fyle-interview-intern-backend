...
class Assignment(db.Model):
    ...
    def submit(cls, _id, teacher_id, auth_principal: AuthPrincipal):
        ...
        # UPDATING ASSIGNMENT STATE to SUBMITTED from DRAFT
    ...
    #### Updated get_assignments_by_teacher() to properly use this function implementing structure like get_assignments_by_student()
    @classmethod
    def get_assignments_by_teacher(cls, teacher_id):
        return cls.filter(cls.teacher_id == teacher_id).all()

    # ADDING TO GET ASSIGNMENT WHICH ARE SUBMITTED OR GRADED
    @classmethod
