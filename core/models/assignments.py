...
class Assignment(db.Model):
    ...
    def mark_grade(cls, _id, grade, auth_principal: AuthPrincipal):
        ...
        assertions.assert_valid(assignment.teacher_id == auth_principal.teacher_id, 'This assignment was submitted to another teacher')
        assertions.assert_valid(assignment.state == AssignmentStateEnum.SUBMITTED, 'draft assignment cannot be graded')
    ...
    def re_grade(cls, _id, grade, auth_principal: AuthPrincipal):
        ...
        assertions.assert_found(assignment, 'No assignment with this id was found')
        assertions.assert_valid(grade is not None, 'assignment with empty grade cannot be graded')
        assertions.assert_valid(auth_principal.principal_id is not None, 'draft assignment cannot be graded')
        assertions.assert_valid(assignment.state == AssignmentStateEnum.GRADED, 'draft assignment cannot be graded')
