...
class Assignment(db.Model):
    ...
    def submit(cls, _id, teacher_id, auth_principal: AuthPrincipal):
        ...
        assertions.assert_valid(assignment.content is not None, 'assignment with empty content cannot be submitted')
        assertions.assert_valid(assignment.state is AssignmentStateEnum.DRAFT, 'only a draft assignment can be '
                                                                               'submitted')
    ...
    def mark_grade(cls, _id, grade, auth_principal: AuthPrincipal):
        ...
        if auth_principal.teacher_id is not None:
            assertions.assert_valid(assignment.teacher_id == auth_principal.teacher_id, 'This assignment is assigned '
    ...
    def get_assignments_by_principal(cls):
        return cls.filter(
            db.or_(cls.state == AssignmentStateEnum.SUBMITTED, cls.state == AssignmentStateEnum.GRADED)).all()
