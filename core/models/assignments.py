...
class Assignment(db.Model):
    ...
    def assign_grade(cls, _id, grade, principal: Principal):
        ...
        assignment = Assignment.get_by_id(_id)
        assertions.assert_found(assignment, 'No assignment with this id was found')
        assertions.assert_true(assignment.teacher_id == principal.teacher_id, 'Only the assigned teacher can grade this assignment')
        assertions.assert_valid(assignment.state == AssignmentStateEnum.SUBMITTED, 'This assignment cannot be graded as it is not in the submitted state')
