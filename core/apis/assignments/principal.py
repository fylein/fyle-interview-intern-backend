...
principal_assignments_resources_grade = Blueprint('principal_assignments_resources_grade', __name__)
...
@principal_assignments_resources_grade.route('assignments/grade', methods=['POST'], strict_slashes=False)
